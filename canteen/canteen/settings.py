...
DEFAULT_VAPID_PUBLIC_KEY = "BBLdS-hjjyEd8udkLO8sjPfVfo9cuabYhhHamlWWx63ZxaEOWytLIIROhZ-t6itD5ZOmnEyQGysKM0saTIPYMxU"
DEFAULT_VAPID_PRIVATE_KEY = "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgNVUGHCgROuxdgiVQnr7XtEbqpjuHVHRDKcUo0DvyMW-hRANCAAQS3UvoY48hHfLnZCzvLIz31X6PXLmm2IYR2ppVlset2cWhDlsrSyCEToWfreorQ-WTppxMkBsrCjNLGkyD2DMV"
DEFAULT_VAPID_ADMIN_EMAIL = "mailto:medibite.hub26@gmail.com"

def _setup_vapid_keys():
    env_public = os.environ.get("VAPID_PUBLIC_KEY") or DEFAULT_VAPID_PUBLIC_KEY
    env_private = os.environ.get("VAPID_PRIVATE_KEY") or DEFAULT_VAPID_PRIVATE_KEY
    env_email = os.environ.get("VAPID_ADMIN_EMAIL") or DEFAULT_VAPID_ADMIN_EMAIL
